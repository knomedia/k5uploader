define(['defaults'], function(defaults){
  ...
  K5Options = (function(){
    K5Options.name = 'K5Options';

    function K5Options (options){
    }
    ...
    K5Options.prototype.mergeDefaults = function(options) {
      this.sessionUrl= '/api/v1/kaltura_session';
      this.uploadUrl= '';
      this.entryUrl= '';
      this.uiconfUrl= '';
      this.entryDefaults = {
      ...
      defaults('partnerData', this.entryDefaults, options)
      defaults('conversionProfile', this.entryDefaults, options)
      defaults('source', this.entryDefaults, options)
      defaults('kshow_id', this.entryDefaults, options)
      defaults('quick_edit', this.entryDefaults, options)
    }
